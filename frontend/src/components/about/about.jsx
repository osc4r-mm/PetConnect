...
const About = () => (
  <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-green-100 to-blue-50">
    <div className="bg-white shadow-xl p-8 rounded-2xl max-w-3xl w-full animate-fadeIn">
