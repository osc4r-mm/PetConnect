...
const mockPets = [
  {
    ...
    description: 'Luna es una labrador juguetona y llena de energía. Le encanta correr y perseguir pelotas en el parque. Es muy cariñosa con los niños.'
  },
  {
    id: 2,
    name: 'Milo',
    ...
    description: 'Milo es un beagle tranquilo pero curioso. Disfruta de paseos moderados y es perfecto para compañía. Ladra ocasionalmente cuando detecta algo interesante.'
  },
  {
    id: 3,
    name: 'Max',
    ...
    description: 'Max es un bulldog grande y enérgico. A pesar de su tamaño, es muy cariñoso y protector. Le encanta jugar y puede ser bastante ruidoso cuando está emocionado.'
  },
  {
    id: 4,
    name: 'Nala',
    ...
    description: 'Nala es una chihuahua pequeña y tranquila. Es una compañera perfecta para espacios reducidos. Es muy silenciosa y prefiere relajarse en el sofá contigo.'
  },
];
...
export default function Home() {
  ...
  const filteredPets = mockPets.filter(pet => {
    ...
    const matchesAdoptionOrSitting = 
      (!filters.for_adoption && !filters.for_sitting) || // No hay filtros activados
      (filters.for_adoption && pet.for_adoption) ||               // Coincide con adopción 
      (filters.for_sitting && pet.for_sitting); // Coincide con cuidado
