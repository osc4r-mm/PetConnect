...
const Caregivers = () => (
  <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
    <div className="bg-white shadow-lg rounded-lg p-8 max-w-2xl w-full">
      <h1 className="text-3xl font-bold mb-4 text-green-700">Acerca de PetConnect</h1>
      ...
      <p className="text-gray-600 mb-2">
        PetConnect ha sido creada por <a className="text-green-600 underline" href="https://github.com/osc4r-mm" target="_blank" rel="noopener noreferrer">Oscar M.M.</a> como parte de un proyecto personal con el fin de ayudar a las mascotas a encontrar un hogar o los mejores cuidados cuando sus familias lo necesitan.
      </p>
      <p className="text-gray-600">
        ¿Tienes sugerencias o deseas colaborar? Visita nuestra página de <a href="/contacto" className="text-green-600 underline">contacto</a>.
      </p>
    </div>
  </div>
);
